...
class Cnvrsn_Event_Dispatcher {
	...
	/**
	 * Constructor for Cnvrsn_Event_Dispatcher class
	 */
	...
	public function enqueue_scripts() {
		echo '<!-- Begin: WooCommerce Cnvrsn Trckng -->' . PHP_EOL;
		foreach ( $this->integrations as $integration ) {
			$integration->enqueue_script();
		}
		echo '<!-- End: WooCommerce Cnvrsn Trckng -->' . PHP_EOL;
	}
}
